...
class EFDNSR_K1(nn.Module):
    ...
    def forward(self, x, y):
        ...
        landmark = self.conv_1(y)

        out_b1 = self.block_1(out_feature_early+landmark)
        out_b2 = self.block_2(out_b1+landmark)
        out_b3 = self.block_3(out_b2+landmark)
        out_b4 = self.block_4(out_b3+landmark)
        out_b5 = self.block_5(out_b4+landmark)
        out_b6 = self.block_6(out_b5+landmark)
